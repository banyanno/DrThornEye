...
Public Class MainTakeoInventory
    ...
    Dim DashEyeExamination As MainEyeExamForm
    ...
    Dim DasLabolatory As New UCWaitingLabolatory
    ...
    Sub InitUserControle()
        ...
        Login.UpdateLabelStatus("Creating user interface.", True)
        Application.DoEvents()
        DashEyeExamination = New MainEyeExamForm
        Login.UpdateLabelStatus("Create Eye examination form", True)
        Application.DoEvents()
    ...
    Private Sub BottonBarMain_ItemClick(ByVal sender As System.Object, ByVal e As Janus.Windows.ButtonBar.ItemEventArgs) Handles BottonBarMain.ItemClick
        Select Case e.Item.Key
            ...
            Case "EyeExaminationForm"
                GeneralAddControl(uiPanelMainContainer, DashEyeExamination, "Eye examination form ...")
            Case "CountMG"
            ...
            Case "Labolatory"
                GeneralAddControl(uiPanelMainContainer, DasLabolatory, "Patient labolatory List...")
